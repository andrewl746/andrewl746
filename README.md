...
I enjoy building software that makes people's lives easier. Founder of [OlympIQ](https://www.olympiq.ca), a team management platform set to be used by my high school's 60+ Science Olympics competitors next season.

## Featured Projects

| Project | What it does | Built with |
| --- | --- | --- |
| **[OlympIQ](https://www.olympiq.ca)** · Live | Set to manage my high school's Science Olympics team by handling scheduling with conflict detection and preference-based event assignment. | Next.js, TypeScript, Firebase |
