...
I enjoy building software that makes people's lives easier. Founder of [OlympIQ](https://www.olympiq.ca), a team management platform set to be used by 60+ Science Olympics competitors next season.

## Featured Projects

| Project | What it does | Built with |
| --- | --- | --- |
| **[OlympIQ](https://www.olympiq.ca)** · Live | Set to manage my high school’s Science Olympics team by handling scheduling with conflict detection, assigning events based on preferences, tracking attendance, and providing easy Excel exports. | Next.js, TypeScript, Firebase |
...
![Views](https://api.visitorbadge.io/api/visitors?path=https%3A%2F%2Fgithub.com%2Fandrewl746&label=Views%3A&labelColor=%23697689&countColor=%23d9e3f0&labelStyle=upper)⠀
