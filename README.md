...
| --- | --- | --- |
| **[OlympIQ](https://www.olympiq.ca)** · Live | Runs my high school's Science Olympics team: scheduling with conflict detection, preference-based event assignment, attendance, Excel export. | Next.js, TypeScript, Firebase |
